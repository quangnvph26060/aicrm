                                    ...
                                    <li data-id="{{ $item->id }}" class="product_inventory">
                                        <div style="display: flex; ">
                                            ...
                                            <div class="ovh">
                                                ...
                                                <p class="ng-binding">
                                                    <span class="ng-binding"> <span style="padding-right: 20px">{{
                                                            $item->code }}</span>Giá : {{ $item->price }}</span>
                                    ...
                                    <form action="{{ route('admin.importproduct.importCoupon.add') }}" id="addimport"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-wrapper form-labels-220">
                                                ...
                                                <input type="text" id='total_input' name="total" style="display: none;">
                                                <div class="form-group">
                                                    <div class="pull-left user-created control-label ng-binding">
                                                        <span><i class="fa fa-user-circle-o"
                                                                title="Người tạo"></i></span>
                                                    ...
                                                    <div class="pull-right" style="width: 80px;">
                                                        <div style="border-bottom: 1px solid; text-align: end; color: #007bff"
                                                            id='tientra' class="editable" contenteditable="true"></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" onclick="submitadd(event)">Lưu
                                            </button>
                                        </div>
                                    </form>
                                </div>
    ...
    $j(document).ready(function(){
        $j.ajax({
            ...
            success: function(data) {
                ...
                cantra.empty();  cantra.html(data.total) ;
                tientra.empty();  tientra.html(data.total) ;
