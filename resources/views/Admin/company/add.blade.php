                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="new-supplier-name" name="name" required>
                                </div>
                                <div class="form-group">
                                    <label for="new-supplier-email">Email:</label>
                                    <input type="email" class="form-control" id="new-supplier-email" name="email" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="new-supplier-phone" name="bank_account">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="new-supplier-phone" name="tax_number">
                                </div>
                                <div class="form-group">
