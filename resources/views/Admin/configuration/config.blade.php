    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="admin.config.detail">Cấu hình</a>
                </li>
            </ul>
        </div>
        <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" class="form-control @error('phone') is-invalid @enderror"
                                            ...
                                            value="{{ old('phone', isset($data) ? $data->phone : '') }}" required>
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="bank_account"
                                            ...
                                            name="bank_account" type="bank_account"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="bank_name" class="form-control @error('bank_name') is-invalid @enderror"
                                            name="bank_name" type="bank_name"
                                            value="{{ old('bank_name', isset($data) ? $data->bank_name : '') }}" required>
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        {{-- @if ($data->user_info && $data->user_info->img_url) --}}
