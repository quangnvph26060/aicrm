                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name_bank" class="form-control @error('name_bank') is-invalid @enderror"
                                        name="name_bank" type="text"
                                        value="{{ old('name_bank', isset($data) ? $data->tin : '') }}">
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bank" id="bank" class="form-control">
                                        ...
                                        <option @if(isset($data) && $data->bank_id == $item->id)
                                            selected
                                        @endif value="{{ $item->id}}">{{$item->shortName.' - '. $item->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
